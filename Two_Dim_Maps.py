...
def TwoDim_MapLogScale(M,N,k0,d,x,y,x_title,y_title,file_name,title,vmin,vmax):
    fig, axes = plot.subplots(1,1,figsize=(6,3))
    ...
    pcm = axes.pcolor(x,y,M,shading='auto',norm=colors.LogNorm(vmin=vmin,vmax=vmax),cmap=cm.gist_rainbow)
