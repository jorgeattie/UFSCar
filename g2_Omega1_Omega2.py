...
path_data = "../results/data/QT/Matrix_hdf5/" 
if not os.path.exists(path_data): 
    os.makedirs(path_data)

filename = path_data+filename_generator.filename_gen("g2",N,k0,d) #Mudar para N, sensor, kd e omega e delta   

#Fazer dentro do looping um omega_list salvo no hdf5
...
g2_s_Matrix = f['/1/g2']
#Também para o omega_list
#Achar o 10^0 no color bar
